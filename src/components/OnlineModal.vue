  ...
  <div class="overlay" :class="{ active: modelValue }" @click.self="closeModal">
    <div class="overlay-card fen-modal-card online-modal">
      <div class="modal-header">
        <h3 class="modal-title">🌐 双人实时联机对决 (免登录)</h3>
      ...
      <div class="nickname-bar">
        ...
        />
        <span class="tip-badge">自动保存</span>
      </div>
      ...
      <div v-if="!isConnected" class="online-setup">
        ...
        <div v-if="activeTab === 'create'" class="tab-content">
          <div v-if="onlineStatus === 'disconnected' || onlineStatus === 'error'" class="action-box">
            <p class="desc">点击下方按钮生成专属房间码，发给好友即可秒级连线对弈！</p>
          ...
          <div v-else-if="onlineStatus === 'creating' || onlineStatus === 'waiting'" class="waiting-box">
            ...
            <div class="copy-actions">
              <button class="btn btn-primary" @click="copyRoomLink">
            ...
            <div class="spinner-container">
              ...
              <p class="waiting-subtext">好友打开链接或在网页输入房间码即可自动进房！</p>
            </div>
        ...
        <div v-if="activeTab === 'join'" class="tab-content">
          <div class="join-box">
            <p class="desc">请输入好友发给你的 6 位房间码：</p>
            <div class="join-input-row">
              <input
                type="text"
                v-model="inputCode"
                maxlength="6"
                placeholder="例如: 884888"
                class="room-input"
      ...
      <div class="modal-footer-tip">
        💡 基于 WebRTC P2P 浏览器直连，无需注册、零中转延迟、全免费。
      </div>
    </div>
  </div>
</template>
