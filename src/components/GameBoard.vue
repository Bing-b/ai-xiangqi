    ...
    <div class="board-wrapper" :class="{ vibrate: vibrateBoard }">
      ...
      <div class="piece-layer">
        <template v-for="(row, r) in grid" :key="'row-' + r">
          ...
          >
            <!-- Final Position Marker (Where piece landed after move) -->
            ...
            <div
              v-if="piece"
              class="piece"
              :class="piece[0] === 'r' ? 'piece-red' : 'piece-black'"
            >
...
const isLastMoveFrom = (r, c) =>
  props.lastMove && props.lastMove.fromR === r && props.lastMove.fromC === c;
const isLastMoveTo = (r, c) =>
  props.lastMove && props.lastMove.toR === r && props.lastMove.toC === c;
...
const getCellClass = (r, c) => {
  ...
  if (
    ...
    props.selectedSquare.r === r &&
    props.selectedSquare.c === c
  ) {
